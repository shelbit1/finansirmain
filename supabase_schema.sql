-- ============================================================================
--  Финансыр · Схема базы данных для Supabase (SQL Editor)
-- ============================================================================
--  Это автоген из prisma/schema.prisma (prisma migrate diff).
--
--  Используйте ЭТОТ файл, только если хотите создать таблицы вручную через
--  SQL Editor. Альтернатива (рекомендуется) — выполнить `npm run db:push`,
--  тогда этот файл не нужен.
--
--  ПОРЯДОК: 1) этот файл (схема) → 2) supabase_setup.sql (RLS и доступы).
-- ============================================================================
